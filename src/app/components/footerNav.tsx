...
export default function FooterNav() {
    ...
    return (
        <div
        className="fixed bottom-0 w-full bg-[white] text-gray-700 z-50 
        ...
        <Link href="/app" className="flex flex-col items-center">
            <HomeIcon
            className={`h-6 w-6 ${
                isActive("/app") ? "text-[#3F3632]" : "text-gray-500"
            }`}
            />
            <span
            className={`text-sm ${
        ...
        <Link href="/app/profile" className="flex flex-col items-center">
            <UserIcon
            className={`h-6 w-6 ${
                isActive("/app/profile") ? "text-[#3F3632]" : "text-gray-500"
            }`}
            />
            <span
            className={`text-sm ${
        ...
        <Link href="/app/events" className="flex flex-col items-center">
            <CalendarDaysIcon
            className={`h-6 w-6 ${
                isActive("/app/events") ? "text-[#3F3632]" : "text-gray-500"
            }`}
            />
            <span
            className={`text-sm ${
        ...
        <Link href="/app/scan" className="flex flex-col items-center">
            <QrCodeIcon
            className={`h-6 w-6 ${
                isActive("/app/scan") ? "text-[#3F3632]" : "text-gray-500"
            }`}
            />
            <span
            className={`text-sm ${
